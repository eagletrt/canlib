...
TEMPLATE_PROTO_INTERFACE_CPP = j2.Template((BASE_DIR / "proto_interface.h.j2").read_text())
...
def generate(network: Network, schema: Schema, output_dir: Path):
    ...
    mapping_path.write_text(TEMPLATE_PROTO_INTERFACE_CPP.render(network=network, schema=schema))
