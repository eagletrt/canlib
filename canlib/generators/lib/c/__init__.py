...
TEMPLATE_UTILS = j2.Template((BASE_DIR / "utils.h.j2").read_text())
...
def generate(network: Network, schema: Schema, output_path: Path):
    ...
    utils_path = output_path / "utils.h"
    utils_path.write_text(TEMPLATE_UTILS.render(network=network, schema=schema))
